...
significance: |
  It is natural to assume that a more accurate and precise forecast will lead to better decisions
  than a less accurate one.  I demonstrate that this premise is false, and illustrate how a 
  decision-theoretic approach provides better criteria for chosing a forecast model than forecast skill.
  As the expansion of machine learning methods and big data lead to increasing more accurate and
  precise forecasts in many fields, we should remember that alone is not enough to jettison earlier 
  models.
...
forecasting as the answer
forecasting is not always the answer


A primary purpose of statistical analyses and ecological modeling is to make forecasts for the future [@Clark2001; @Gneiting2014].  Accurate forecasts are important both in assessing the accuracy of our models and understanding of natural processes, they also underpin policy and decision making [@Dietze2018]. "Strictly proper" scoring rules [sensu @Gneiting2007] provide mathematical guarantee that they will, on average, select the true model over any other, paving the way for ever more complex and more accurate forecasting models. Unlike alternative measures of 'goodness of fit' forecasts are
