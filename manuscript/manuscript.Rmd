...
This example also illustrates the importance of decision constraints -- a model that gives very good outcomes when we are free to vary the harvest quota each year (the optimal control problem here) may give very poor results under the constraint of constant mortality, and vice versa. 
