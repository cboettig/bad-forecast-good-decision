...
under the true process [@Burnham2002].  Over-fitting is a central concern of any model comparison
...
world [@Deitze2018], and the approach is already well established in the principle of 
adaptive management [@Walters1978] and existing practices such as Management Strategy Evaluation (MSE)
[@Punt2006] used in fisheries. Given this ability to decrease uncertainty and avoid over-fitting,
...
Put another way, the value of information [@Howard1966], as measured by the expected utility given that 
...
Increasing the space of possible models to cover a whole plausible range of parameters $r$ and $K$ does nothing to resolve the problem [Fig 4].  
