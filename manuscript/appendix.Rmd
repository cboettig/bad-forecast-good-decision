...
am1 <- adaptive_management(transitions[1:2], reward, discount, model_prior = c(0.99, 0.01), x0 = x0, 
...
mean(states[am$state]) / mean_state[[1, "state"]]
```
