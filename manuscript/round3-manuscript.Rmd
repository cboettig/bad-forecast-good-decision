...
I will present two examples of this "forecast trap" and examine how it arises.
...
## Iterative upates and adaptive management
...
A manager may also escape the forecast trap by exploring actions which are never recommended from any of the available forecasts.
...
a process known as curriculum learning [@curriculum-learning], mimics the scenario analyses and search for . Such approaches have been used to train agents to play 2600 Atari console games at superhuman ability [@], outperform race-car drivers [@sony] and control nuclear fusion reactions [@deepmind-fusion].
