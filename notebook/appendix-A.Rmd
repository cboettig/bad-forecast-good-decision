---
output: pdf_document
title: Appendix A: Multispecies models
---

The model which gives the best forecast does not always lead to the best decision. 


We consider a simulated system described by the 5-dimensional model of a herring fishery presented in @Brias2021:
...
While richer numerical models can successfully capture the full complexity of this five-dimensional model, we must remember that reality is always more complex than our models.
As the term implies, models intentional simplifications of reality. 


- Model A: A reasonable approximation model that produces more accurate forecasts but leads to substantially worse management outcomes
- Model B: A reasonable approximation model that does not produce very accurate forecasts, but nevertheless leads to good management decisions.
- Model C: The "True" Model: five-species model; functional forms and parameter values are never disclosed to the 'manager' but are used to simulate all data and management scenarios.
