...
Note that the pattern is not driven merely be differences in the unfished equilibrium.  Compare forecast performance under management.  Score is the sum of the log probabilities of observed outcomes, given the 
